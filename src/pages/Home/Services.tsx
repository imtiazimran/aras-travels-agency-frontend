...
export function Services() {
  return (
    <div className="w-full relative overflow-hidden bg-slate-900">
      ...
      <Container className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full h-auto py-10">
        <WobbleCard
        ...
        >
          <div className="max-w-xs">
            ...
            <p className="mt-4 text-left text-base/6 text-neutral-200">
              AV Visa Agency specializes in helping individuals and businesses
              navigate the complexities of work visa applications. We streamline
              the process to ensure a smooth and efficient experience.
            </p>
        ...
        <WobbleCard containerClassName="col-span-1 min-h-[300px] bg-green-800">
          <div className="max-w-xs">
            ...
            <p className="mt-4 max-w-[26rem] text-left text-base/6 text-neutral-200">
              Book your international and domestic flights hassle-free with AV
              Visa Agency. We provide the best deals and the most convenient
              flight options.
            </p>
        ...
        <WobbleCard containerClassName="col-span-1 lg:col-span-3 bg-red-800 min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
          <div className="max-w-sm">
            ...
            <p className="mt-4 max-w-[26rem] text-left text-base/6 text-neutral-200">
              AV Visa Agency simplifies the process of applying for tourist and
              visitor visas, helping you get your visa quickly so you can focus
              on your trip.
            </p>
            <ul className="mt-2 text-left text-sm text-neutral-200">
